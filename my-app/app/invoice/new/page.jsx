...
function CreateInvoice() {
  ...
  function handleViewInvoices() {
    router.push("/invoice"); // Navigate to /invoice page
  }
  ...
  return (
    <div className="bg-slate-50 py-8 md:py-8 px-4 md:px-16">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-4">
          ...
          <button
            ...
            className="px-3 py-2 rounded-sm border border-slate-600 flex items-center space-x-2"
          >
            <AiOutlineFileText />
      ...
      {preview ? (
        <div ref={invoiceRef} className="previewContainer">
          <FormPreview data={combinedData} />
        </div>
      ) : (
        <form
          onSubmit={handleFormSubmit}
          className="formContainer w-11/12 max-w-[900px] mx-auto p-4 max-h-[80vh] overflow-y-auto"
        >
          {/* image & invoice label */}
          <div className="flex justify-between items-center">
            <div className="flex items-center justify-center">
              {logoUrl ? (
                ...
                <div>
                  <CldUploadButton
                    className="flex flex-col items-center justify-center w-48 h-24 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 text-gray-500 text-sm  dark:text-gray-400"
                    onSuccess={(data) => {
